...
type GithubProject struct {
	...
	AccessGroups any `json:"accessGroups" api:"required"`
	...
	Repository GithubProjectGithubProjectRepository `json:"repository" api:"nullable"`
...
type GithubProjectGithubProjectRepository struct {
	...
	JSON githubProjectGithubProjectRepositoryJSON `json:"-"`
}

// githubProjectGithubProjectRepositoryJSON contains the JSON metadata for the struct [GithubProjectGithubProjectRepository]
type githubProjectGithubProjectRepositoryJSON struct {
...
func (r *GithubProjectGithubProjectRepository) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r githubProjectGithubProjectRepositoryJSON) RawJSON() string {
	return r.raw
}

type GithubProjectGithubProjectRepositoryParam struct {
	Branch param.Field[string] `json:"branch" api:"required"`
	ConfigPath param.Field[string] `json:"configPath" api:"required"`
	Expired param.Field[bool] `json:"expired" api:"required"`
	ID param.Field[float64] `json:"id" api:"required"`
	LinkedBy param.Field[string] `json:"linkedBy" api:"required"`
	Name param.Field[string] `json:"name" api:"required"`
	PrComments param.Field[bool] `json:"prComments" api:"required"`
	PublishOnMerge param.Field[bool] `json:"publishOnMerge" api:"required"`
	PublishPreviews param.Field[bool] `json:"publishPreviews" api:"required"`
}

func (r GithubProjectGithubProjectRepositoryParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

type ScalarDocListGuidesResponse struct {
	Message string `json:"message" api:"required"`
	Code string `json:"code" api:"required"`
	JSON scalarDocListGuidesResponseJSON `json:"-"`
}

// scalarDocListGuidesResponseJSON contains the JSON metadata for the struct [ScalarDocListGuidesResponse]
type scalarDocListGuidesResponseJSON struct {
...
func (r *ScalarDocListGuidesResponse) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r scalarDocListGuidesResponseJSON) RawJSON() string {
	return r.raw
}
