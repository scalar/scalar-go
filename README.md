...
// imports: sdk "scalar-api", "errors", "fmt"
```
...
// imports: sdk "scalar-api", "scalar-api/option", "time"
```
...
| `option.WithBaseURL` | `func(string) option.RequestOption` | `os.Getenv("SCALAR_API_BASE_URL")` | Override the default API base URL. |
