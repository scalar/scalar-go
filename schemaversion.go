...
//
//	fmt.Println(version)
func (r *SchemaVersionService) Get(ctx context.Context, namespace string, slug string, semver string, opts ...option.RequestOption) (res *string, err error) {
...
//
//	fmt.Println(version)
func (r *SchemaVersionService) Delete(ctx context.Context, namespace string, slug string, semver string, opts ...option.RequestOption) (res *map[string]interface{}, err error) {
	opts = slices.Concat(r.Options, opts)
	if namespace == "" {
		err = errors.New("missing required namespace parameter")
		return nil, err
...
//	namespace: Path parameter.
//	slug: Path parameter.
//	body: SchemaVersionNewParams request parameters.
//	opts: Options to apply to this request.
//
// Returns:
//
