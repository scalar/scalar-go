...
| Direction | Type |
| --- | --- |
| Request | [`SchemaNewVersionParams`](./schema.go) |
| Response | [`SchemaNewVersionResponse`](./schema.go) |
...
| Direction | Type |
| --- | --- |
| Request | [`SchemaNewAccessGroupParams`](./schema.go) |
...
| Direction | Type |
| --- | --- |
| Request | [`SchemaDeleteAccessGroupParams`](./schema.go) |
