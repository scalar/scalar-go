...
type LoginPortalUpdateResponse struct {
	Message string `json:"message" api:"required"`
	Code string `json:"code" api:"required"`
	JSON loginPortalUpdateResponseJSON `json:"-"`
}

// loginPortalUpdateResponseJSON contains the JSON metadata for the struct [LoginPortalUpdateResponse]
type loginPortalUpdateResponseJSON struct {
	Message apijson.Field
	Code apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
...
func (r *LoginPortalUpdateResponse) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r loginPortalUpdateResponseJSON) RawJSON() string {
	return r.raw
}

type LoginPortalDeleteResponse struct {
	Message string `json:"message" api:"required"`
	Code string `json:"code" api:"required"`
	JSON loginPortalDeleteResponseJSON `json:"-"`
}

// loginPortalDeleteResponseJSON contains the JSON metadata for the struct [LoginPortalDeleteResponse]
type loginPortalDeleteResponseJSON struct {
	Message apijson.Field
	Code apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
...
func (r *LoginPortalDeleteResponse) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r loginPortalDeleteResponseJSON) RawJSON() string {
	return r.raw
}
...
type LoginPortalListResponse struct {
	Message string `json:"message" api:"required"`
	Code string `json:"code" api:"required"`
	JSON loginPortalListResponseJSON `json:"-"`
}

// loginPortalListResponseJSON contains the JSON metadata for the struct [LoginPortalListResponse]
type loginPortalListResponseJSON struct {
	Message apijson.Field
	Code apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
...
func (r *LoginPortalListResponse) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r loginPortalListResponseJSON) RawJSON() string {
	return r.raw
}
